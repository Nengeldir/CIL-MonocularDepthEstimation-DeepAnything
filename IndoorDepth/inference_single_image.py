...
def inference(args):
    ...
    with torch.no_grad():
        ...
        # Remove cropping
        # input_image = input_image.crop((16, 16, 640-16, 480-16))  # Comment or remove this line
        ...
        disp = outputs[("disp", 0)]
        # Resize the output back to the original dimensions
        ...
        # Use the resized disparity map for saving
