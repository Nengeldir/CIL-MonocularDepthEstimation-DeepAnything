...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--data_path",
                                 ...
                                 default=os.path.join(file_dir, "data"))  # Updated default path
        ...
        self.parser.add_argument("--split",
                                 ...
                                 choices=["nyu", "deep_anything"],  # Added "deep_anything"
                                 default="deep_anything")  # Set default to your dataset
        ...
        self.parser.add_argument("--height",
                                 ...
                                 default=480)  # Updated to match your dataset
        self.parser.add_argument("--width",
                                 type=int,
                                 help="input image width",
                                 default=640)  # Updated to match your dataset
        ...
        self.parser.add_argument("--min_depth",
                                 type=float,
                                 help="minimum depth",
                                 default=0.01)  # Updated to match your dataset
        ...
        self.parser.add_argument("--val_split",
                                 type=float,
                                 help="percentage of data to use for validation (0.0 to 1.0)",
                                 default=0.1)  # Default to 10% validation split
        ...
        self.parser.add_argument("--eval_split",
                                 type=str,
                                 default="deep_anything",  # Updated to match your dataset
                                 choices=["nyu", "deep_anything"],  # Added "deep_anything"
